...
| [no\_password\_expiration](#no_password_expiration) | `boolean` | Optional | cannot be null | [add-user input](add-user-input-properties-no-password-expiration.md "http://schema.nethserver.org/openldap/add-user-input.json#/properties/no_password_expiration") |
...
| [phone\_extension](#phone_extension)                | `string`  | Optional | cannot be null | [add-user input](add-user-input-properties-phone-extension.md "http://schema.nethserver.org/openldap/add-user-input.json#/properties/phone_extension")               |
...
True, if the user password never expires

`no_password_expiration`

* is optional

* Type: `boolean` ([No password expiration](add-user-input-properties-no-password-expiration.md))

* cannot be null

* defined in: [add-user input](add-user-input-properties-no-password-expiration.md "http://schema.nethserver.org/openldap/add-user-input.json#/properties/no_password_expiration")
...
* Type: `string` ([Phone extension](add-user-input-properties-phone-extension.md))

* cannot be null

* defined in: [add-user input](add-user-input-properties-phone-extension.md "http://schema.nethserver.org/openldap/add-user-input.json#/properties/phone_extension")
