...
| [no\_password\_expiration](#no_password_expiration) | `boolean` | Optional | cannot be null | [alter-user input](alter-user-input-properties-no-password-expiration.md "http://schema.nethserver.org/openldap/alter-user-input.json#/properties/no_password_expiration") |
...
| [phone\_extension](#phone_extension)                | `string`  | Optional | cannot be null | [alter-user input](alter-user-input-properties-phone-extension.md "http://schema.nethserver.org/openldap/alter-user-input.json#/properties/phone_extension")               |
...
* defined in: [alter-user input](alter-user-input-properties-no-password-expiration.md "http://schema.nethserver.org/openldap/alter-user-input.json#/properties/no_password_expiration")
...
* Type: `string` ([Phone extension](alter-user-input-properties-phone-extension.md))

* cannot be null

* defined in: [alter-user input](alter-user-input-properties-phone-extension.md "http://schema.nethserver.org/openldap/alter-user-input.json#/properties/phone_extension")
